  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"'DM Sans','Helvetica Neue',sans-serif"}}>
      ...
      <div style={{maxWidth:940,margin:"0 auto",padding:"32px 20px 60px"}}>
        ...
        {/* ═══ STEP 2 ═══ */}
        {step===2&&(()=>{
          const cookLbls=["always eating out","mostly eating out","a mix","mostly cooking","always cooking at home"];
          const filled=[
            profile.kcal!==2500, profile.cook!==3, profile.out!==2,
            profile.sport!==0, profile.cinema!==0, profile.smoke!==0,
            profile.stream!==0, profile.cloth!==30, profile.buf!==5,
            housing!=="room"||zone!=="outside",
          ];
          ...
          const showHeadphones=profile.stream>0; const showTicket=profile.cinema>0&&!showHeadphones;
          ...
          return(
            <div className="fu" style={{display:"flex",flexDirection:"column",gap:14}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 200px",gap:14,alignItems:"start"}}>
                ...
                <div className="card">
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
                    ...
                    <div style={{display:"flex",gap:4}}>
                      {filled.map((ok,i)=>(
                        <div key={i} style={{width:7,height:7,borderRadius:"50%",background:ok?accOn:"#1c1c38",transition:"background .3s"}}/>
                      ))}
                    </div>
                  </div>
                  <div style={{display:"flex",flexDirection:"column",gap:14}}>
                    ...
                    <FieldRow label="Eating habits" value={cookLbls[profile.cook-1]}>
                    ...
                    <FieldRow label="Streaming">
                      <ToggleGroup field="stream" options={["None","1 subscription","2+ subscriptions"]}/>
                    </FieldRow>
                ...
                {/* SVG Character panel */}
                <div style={{background:"#0a0a1a",borderRadius:12,border:`1px solid ${C.border}`,padding:"16px 12px",display:"flex",flexDirection:"column",alignItems:"center",gap:10,position:"sticky",top:20}}>
                  <span className="mono" style={{fontSize:8,color:C.textDim,letterSpacing:2,textTransform:"uppercase"}}>{nFilled} / {filled.length} filled</span>

                  <svg viewBox="0 0 160 230" width="150" height="216" xmlns="http://www.w3.org/2000/svg">
                    {/* Base skeleton */}
                    <g>
                    ...
                    {/* Apron — cooks at home */}
                    {showApron&&<g style={{opacity:1,transition:"opacity .4s"}}>
                    ...
                    {/* Fork — eats out */}
                    {showFork&&<g transform="translate(122,142)" style={{opacity:1,transition:"opacity .4s"}}>
                    ...
                    {/* Beer — goes out often */}
                    {showBeer&&<g transform="translate(10,140)" style={{opacity:1,transition:"opacity .4s"}}>
                    ...
                    {/* Dumbbell — gym */}
                    {showDumbbell&&<g transform="translate(13,95)" style={{opacity:1,transition:"opacity .4s"}}>
                    ...
                    {showHeadphones&&<g style={{opacity:1,transition:"opacity .4s"}}>
                      <path d="M45 56 Q45 22 80 22 Q115 22 115 56" stroke={accDim} strokeWidth="3" fill="none" strokeLinecap="round"/>
                      <rect x="38" y="52" width="12" height="16" rx="6" fill={accOn}/>
                      <rect x="110" y="52" width="12" height="16" rx="6" fill={accOn}/>
                    </g>}
                    {/* Cinema ticket */}
                    {showTicket&&<g transform="translate(106,162)" style={{opacity:1,transition:"opacity .4s"}}>
                    ...
                    {/* Cigarette */}
                    {showSmoke&&<g style={{opacity:1,transition:"opacity .4s"}}>
                    ...
                    {/* Shield — buffer */}
                    {showShield&&<g transform="translate(68,90)" style={{opacity:1,transition:"opacity .4s"}}>
                  ...
                  <p style={{fontSize:10,color:C.textDim,textAlign:"center",margin:0,lineHeight:1.5}}>
                    {nFilled===0?"Start filling in your profile to build your character":
                     nFilled<5?"Keep going…":
                     nFilled<9?"Almost there!":
